...
@WebServlet("/ProductsUpdateServlet")
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
           ...
           Products p = ProductsDAO.getProductById(id);
            ...
            out.print("<tr><td>ProductName:</td><td><input type='text' name='label' value='" + p.getLabel()+ "'/></td></tr>");
            out.print("<tr><td>Stock:</td><td><input type='text' name='price' value='" + p.getStock() + "'/></td></tr>");
            out.print("<tr><td>Price:</td><td><input type='text' name='stock' value='"+ p.getPrice()+"'/></td></tr> ");
